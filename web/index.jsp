...
<%@ page import="com.videotapesentities.EntityVideotapesManager" %><%--
...
<%
    EntityVideotapesManager entityVideotapesManager = new EntityVideotapesManager();
...
<div class="buttons">
    <form method="post" name="Login" action="videotapes_list.jsp">
        <input type="hidden" name="isLogged" value="<%= isLogged%>" />
        <input type="submit" value="See our videotape list">
    </form>
